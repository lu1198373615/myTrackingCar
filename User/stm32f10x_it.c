...
extern volatile uint8_t FrontSig;
extern volatile uint8_t FrontSig_zero ;
extern volatile uint8_t BackSig;
extern volatile uint8_t T_Flag;    // 丁字路口
extern volatile uint8_t L_Flag;
